...
namespace BC_CONVERT_SUNGHO_RESEND
{
    public class CONVERT
    {
        ...
        private static string strCardTypeName = "[주의]성호_비씨_재배송_컨버트[주의]";
                            ...
                            case "9":
                                if (strBank_code == "020")
                                {
                                    if (_strDong == "1")
                                    {
                                        ...
                                        _sw.WriteLine(_strLine + "0I" + "0012404");
                                    }
                                    else if (_strDong == "4")
                                    {
                                        _sw = new StreamWriter(path + "우리재발송(국기원)_동의_19000", true, _encoding);
                                        _sw.WriteLine(_strLine + "0I" + "0012402");
                                    }
                                    else
                                    {
                                        if (_strChk_add == "1" || _strChk_add == "2" || _strChk_add == "3")
                                        {
                                            ...
                                            _sw.WriteLine(_strLine + "0I" + "0012403");
                                        }
                                        else
                                        {
                                            _sw = new StreamWriter(path + "우리재발송_동의_18000", true, _encoding);
                                            _sw.WriteLine(_strLine + "0I" + "0012401");
                                        }
                                    }
                                }
                            ...
                            default:
                                if (strBank_code == "020")
                                {
                                    if (_strYe == "1" || _strYe == "3")
                                    {
                                        ...
                                        _sw.WriteLine(_strLine + "0I" + "0011111");
                                    }
                                    else
                                    {
                                        _sw = new StreamWriter(path + "우리재발송_일반_8000", true, _encoding);
                                        _sw.WriteLine(_strLine + "0I" + "0011108");
                                    }
                                }
                                else if (strBank_code == "031")
                                {
                                    if (_strYe == "1" || _strYe == "3")
                                    {
                                        ...
                                        _sw.WriteLine(_strLine + "0I" + "0011402");
                                    }
                                    else
                                    {
                                        _sw = new StreamWriter(path + "대구재발송_일반_6000", true, _encoding);
                                        _sw.WriteLine(_strLine + "0I" + "0011401");
                                    }
                                ...
                                else if (strBank_code == "042")
                                {
                                    if (_strYe == "1" || _strYe == "3")
                                    {
                                        ...
                                        _sw.WriteLine(_strLine + "0I" + "0011116");
                                    }
                                    else
                                    {
                                        _sw = new StreamWriter(path + "토스재발송_일반_36000", true, _encoding);
                                        _sw.WriteLine(_strLine + "0I" + "0011115");
                                    }
                                }
                                else
                                {
