...
namespace BC_GIFT_Member
{
	public class CONVERT
	{
        ...
        private static string strCardTypeName = "BC별도_멤버쉽";
        ...
        public static string ConvertRegister(string path, string xmlZipcodePath, string xmlZipcodeAreaPath, string xmlZipcodePath_new, string xmlZipcodeAreaPath_new, string xmlPath)
		{
			...
			try
			{
				...
				_dtable.Columns.Add("card_address");                // dr[10]

                _dtable.Columns.Add("card_zipcode_new");            // dr[11]
                _dtable.Columns.Add("card_zipcode_kind");           // dr[12]
                ...
                while ((_strLine = _sr.ReadLine()) != null)
                {
                    ...
                    _dr[5] = _strAry[0];
                    _dr[6] = _strAry[1];
                    _dr[7] = RemoveDash(_strAry[2]);
                    _dr[8] = _strAry[3];
                    _strZipcode = RemoveDash(_strAry[4]).Trim();
                    _dr[9] = _strZipcode;
