...
namespace _090_농협_반송
{
    public class CONVERT
    {
        ...
        private static string strCardTypeName = "090_농협_반송_재배송";
        ...
        public static string ConvertRegister(string path, string xmlZipcodePath, string xmlZipcodeAreaPath, string xmlZipcodePath_new, string xmlZipcodeAreaPath_new, string xmlPath)
        {
            ...
            string _strReturn = "";
            string _strLine = "";
            string _strZipcode = "", _strAreaType = "", _strAreaGroup = "", _strBranch = "", strZipChk = "", _strOwner_only ="";
            ...
            try
            {
                ...
                _dtable.Columns.Add("card_zipcode3_kind");             //dr[50]
                _dtable.Columns.Add("customer_memo");                  //
                _dtable.Columns.Add("card_number");                    //카드넘버
                _dtable.Columns.Add("card_barcode_new");               //카드 뉴바코드
                _dtable.Columns.Add("client_request_memo");            //별지메모
                _dtable.Columns.Add("card_issue_type_code");           //dr[55]발급구분
                ...
                {   
                    ...
                    if (strZipChk == "1")
                    {
                        _strZipcode = _encoding.GetString(_byteAry, 827, 6).Trim();
                    }
                    else
                    {
                        _strZipcode = _encoding.GetString(_byteAry, 827, 6).Trim();
                    ...
                    _dr[35] = _encoding.GetString(_byteAry, 1097, 6); 
                    _dr[36] = _encoding.GetString(_byteAry, 1103, 50);
                    ...
                    strchk1 = _encoding.GetString(_byteAry, 1185, 8).Replace(' ', '9');
                    _dr[41] = strchk1;
                    strchk2 = _encoding.GetString(_byteAry, 1193, 6).Replace(' ', '9');
                    _dr[42] = strchk2;
                    strchk3 = _encoding.GetString(_byteAry, 1199, 4).Replace(' ', '9');
                    _dr[43] = strchk3;
                    ...
                    //if (_encoding.GetString(_byteAry, 1153, 1) == "1" && (_dr[44].ToString() == "1" || _dr[44].ToString() == "2"))
                    //{
                    //    _dr[54] = "별지";
                    //}
                    ////긴급-긴급 중 동의서 징구 코드의 경우 2015.02.11 태희철 임시 처리
                    //else if (_encoding.GetString(_byteAry, 41, 1) == "1" && _encoding.GetString(_byteAry, 1153, 1) == "1")
                    //{
                    //    _dr[39] = "1";
                    //    _dr[51] = "본인지정배송";

                    //    //농협 별지 제휴코드
                    //    if (_dr[44].ToString() == "1" || _dr[44].ToString() == "2")
                    //    {
                    //        _dr[54] = "별지";   
                    //    }
                    //}
                    ...
                    //2011-09-28[E]
                    //배송코드
                    _dr[52] = _dr[7].ToString().Substring(1, 7) + _dr[8].ToString();

                    //케리어바코드
                    if (_strZipcode.Length == 5)
                    {
                        _dr[53] = _dr[7].ToString() + _dr[8].ToString() + _strZipcode + " " + "01" + "02";
                    }
                    else
                    {
                        _dr[53] = _dr[7].ToString() + _dr[8].ToString() + _strZipcode + "01" + "02";
        ...
        private static string ConvertResultGubun(System.Data.DataTable dtable, string fileName, int temp)
        {
            ...
            try
            {
                ...
                _sw00 = new StreamWriter(fileName + "농협_재방_분실", true, _encoding);
