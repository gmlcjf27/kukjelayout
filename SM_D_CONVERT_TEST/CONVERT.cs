...
namespace SM_D_CONVERT_test
{
    public class CONVERT
    {
        ...
        private static string strCardTypeName = "삼성-D-컨버터_TEST";
        ...
        public static string ConvertRegister(string path, string xmlZipcodeAreaPath, string xmlZipcodePath)
        {
            ...
            try
            {
                ...
                while ((_strLine = _sr.ReadLine()) != null)
                {
                    ...
                    _strCode = _encoding.GetString(_byteAry, 25, 5);
                    ...
                    switch (ConvertStrCode(_strCode))
                    {
                        ...
                        case "SOIL":
                            ...
                            break;
                        case "CAEND":
                            _sw = new StreamWriter(path + ".8000-caend", true, _encoding);
