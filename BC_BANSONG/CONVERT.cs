	...
	public class CONVERT
	{
        ...
        public static string ConvertRegister(string path, string xmlZipcodePath, string xmlZipcodeAreaPath, string xmlZipcodePath_new, string xmlZipcodeAreaPath_new, string xmlBankPath, string xmlPath)
        {
			...
			try {
				...
				_dtable.Columns.Add("client_send_number");                  //dr[10]
				_dtable.Columns.Add("card_count");
				_dtable.Columns.Add("card_customer_regdate");
				_dtable.Columns.Add("delivery_return_date_last");
				_dtable.Columns.Add("delivery_return_reason_last");
				_dtable.Columns.Add("card_zipcode");                        //dr[15]
				...
				while ((_strLine = _sr.ReadLine()) != null) {
					...
					_dr[5] = _strAry[0];
					_strBankID = _strAry[1];
					_dr[6] = _strBankID;
					_dr[7] = _strAry[2].Replace('*', 'x');
					_dr[8] = _strAry[3];
                    _dr[9] = _strAry[4].Replace("-", "").Replace("*", "x");
					_dr[10] = _strAry[5];
					_dr[11] = _strAry[6];
					_dr[12] = _strAry[7];
					_dr[13] = GetBCReturnDate(_strAry[8]);
					_dr[14] = _strAry[9];
                    _dr[18] = _strAry[10].Replace("-", "");
