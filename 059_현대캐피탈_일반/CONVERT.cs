...
namespace _059_현대캐피탈_일반
{
	public class CONVERT
	{
        ...
        private static string strCardTypeID = "088";
        private static string strCardTypeName = "현대캐피탈";
        ...
        public static string ConvertRegister(string path, string xmlZipcodePath, string xmlZipcodeAreaPath, string xmlZipcodePath_new, string xmlZipcodeAreaPath_new, string xmlPath)
        {
            ...
            try
            {
                ...
                _dtable.Columns.Add("card_zipcode");                //dr[20]
                ...
                _dtable.Columns.Add("card_zipcode2");               //dr[25]
                ...
                _dtable.Columns.Add("customer_email_ID");           //dr[30]
                ...
                _dtable.Columns.Add("card_bank_account_owner");     //dr[35]
                _dtable.Columns.Add("card_payment_day");
                _dtable.Columns.Add("card_cooperation1");
                _dtable.Columns.Add("card_limit");
                ...
                _dtable.Columns.Add("customer_name_eng_personal");  //dr[45]
                _dtable.Columns.Add("card_barcode_new");
                //현대캐피탈약정서 데이터의 card_number와 매칭하여 우편번호 입력
                _dtable.Columns.Add("client_number");              //dr[47]

                _dtable.Columns.Add("card_zipcode_new");        //48
                _dtable.Columns.Add("card_zipcode_kind");        //49
                _dtable.Columns.Add("card_zipcode2_new");        //50
                _dtable.Columns.Add("card_zipcode2_kind");        //51
                ...
                while ((_strLine = _sr.ReadLine()) != null)
                {
                    ...
                    _strDeliveryPlaceType = _strAry[27].Trim();
                    ...
                    if (_strDeliveryPlaceType == "")
                    {
                        _strDeliveryPlaceType = "01";
                    }
        ...
        public static string ConvertResult(System.Data.DataTable dtable, string fileName)
        {
            ...
            string _strReturn = "", _strDeliveryStatus = "", strCard_type_detail = "";
            int i_totcnt = 0;
            ...
            try
            {
                ...
                for (i = 0; i < dtable.Rows.Count; i++)
                {
                    ...
                    if (strCard_type_detail == "0591101")
                    {
                ...
                _strReturn = string.Format("{0}건의 인계데이터 다운 완료(약정서론카드 제외)", i_totcnt);
            }
            catch (Exception)
            {
                _strReturn = string.Format("{0}번째 데이터 인계 중 오류 발생", i_totcnt + 1);
            }
            finally
            {
